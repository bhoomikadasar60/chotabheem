...
class Emp{
   ...
   public static void main(String[] args){
    ...
    System.out.println(e2.getName()+"\t\t"+e2.getYear()+"\t\t\t"+e2.getSalary()+"\t"+e2.getAdress()); //printing details of employee 2
    System.out.println(e3.getName()+"\t"+e3.getYear()+"\t\t\t"+e3.getSalary()+"\t"+e3.getAdress()); //printing details of employee 3
  }
}  
